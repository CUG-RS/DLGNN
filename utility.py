...
def make_dual_optimizer(opt, dual_model):
    #dual_optimizers = []
...
def make_dual_scheduler(opt, dual_optimizer):
    #dual_scheduler = []
    #for i in range(len(dual_optimizers)):
    dual_scheduler = lrs.CosineAnnealingLR(
        dual_optimizer,
        float(opt.epochs),
        eta_min=opt.eta_min
    )
