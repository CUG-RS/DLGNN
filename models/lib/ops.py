...
import pyinn
#from pyinn.im2col import im2col
#from pyinn.im2col import Im2Col as pyinn
...
def euclidean_distance(x,y):
    ...
    #print("out.shape:",out.shape) #torch.Size([1, 400, 100])
    return out
'''
out=torch.tensor([[[14],[19]],[[29],[17]],[[14],[20]]])
x=torch.tensor([[[1,9,4]],[[16,9,4]],[[1,4,9]]])  #[[[14]],[[29]],[[14]]]
y=torch.tensor([[[1,9,4],[9,16,4]],[[9,16,4],[1,4,9]],[[1,4,9],[4,9,16]]]) 
'''
'''313
    [[[10, 25,  8]],
        [[10, 20, 13]],
...
'''
'''
out+=x.sum(dim=-1,keepdim=True) #321
