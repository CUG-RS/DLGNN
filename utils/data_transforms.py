...
class Compose(object):
    ...
    def __init__(self, transforms):
        self.transforms = transforms[:-1]  #RandomCrop  FlipRotate   BGR2RGB   RandomColorChannel  
        self.ToTensor = transforms[-1]  #ToTensor
...
class RandomCrop(object):
    ...
    def __call__(self, img_lr, img_hr):
        #img=cv2.imread(img_lr)
        #cv2.imshow('img_lr',img)
        #print(img.path)
