...
def val(cfg, epoch_idx, val_data_loader, net, val_writer):
    ...
    n_batches = min(cfg.TRAIN.MAX_INTERS_PER_EPOCH_VAL, len(val_data_loader))
    ...
    for batch_idx, (_, img_lr_s, img_lr, img_hr) in enumerate(val_data_loader):
        ...
        with torch.no_grad():
            ...
            if batch_idx>cfg.TRAIN.MAX_INTERS_PER_EPOCH_VAL: break
    ...
    # Add alidation results to TensorBoard
